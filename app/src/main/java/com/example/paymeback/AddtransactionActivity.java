...
/**
 * AddtransactionActivity is the activity corresponding to the activity_addtransaction layout.
 *
 * The AddtransactionActivity class contains 3 functions, namely setOnClickListener functions for the three buttons of the CreateGroup layout,
 * AddMember, AddMemberAll and addTransaction.
 *
 * The class also initializes the necessary views, variables and data structures (list and hashmap) that will be utilized in the
 * two setOnClickListener functions, on the creation of the activity.
 *
 * @author Wayne
 */
public class AddtransactionActivity extends AppCompatActivity {
    ...
    /**
     * On Create method when the activity is created. Initializes the necessary buttons, variables and views.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addMember.setOnClickListener(new View.OnClickListener() {
            @Override
            /**
             * The onClick function inside addMember.setOnClickListener determines what happens after the addMember button on the
             * Add Transaction Layout is clicked on. Specifically, the onClick ensures that the added members must be pre-existing
             * members of the TripGroup, are users that are not already inside the transaction, and generates TextViews that showcases
             * the users that are already added into the transaction.
             *
             * @param v
             */
        ...
        addAllMember.setOnClickListener(new View.OnClickListener() {
            @Override
            /**
             * The onClick function inside addAllMember.setOnClickListener determines what happens after the addAllMember button on the
             * Add Transaction Layout is clicked on. Specifically, the onClick adds all members of the TripGroup into the transaction.
             *
             * @param v
             */
            public void onClick(View v) {
        ...
        addTransaction.setOnClickListener(new View.OnClickListener() {
            @Override
            /**
             * The onClick function for addTransaction.setOnClickListener creates a new transaction and adds it into the TripGroup.
             * This function also ensures that the input amount is in a valid format (i.e. numeric format), has more than 1 member,
             * and has a name that is between 2 to 20 characters long. After the transaction is successfully created, the onClick
             * function then starts the GroupView activity.
             *
             * @param v
             */
            public void onClick(View v) {
