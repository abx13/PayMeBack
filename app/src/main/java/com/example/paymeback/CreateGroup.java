...
/**
 * CreateGroup is the activity corresponding to the activity_creategroup layout.
 *
 * The CreateGroup class contains two functions, namely setOnClickListener functions for the two buttons of the CreateGroup layout,
 * AddMember and ConfirmGroup.
 *
...
public class CreateGroup extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addMember.setOnClickListener(new OnClickListener() {
            @Override
            /**
             * The onClick function inside addMember.setOnClickListener determines what happens after the addMember button on the Create Group Layout
             * is clicked on. Specifically, the onClick ensures that the added members must be pre-existing
             * users of the app, are users that are not already inside the group, and generates TextViews that showcases the users that
             * are already added into the group.
             *
             * @param v
             */
        ...
        confirmGroup.setOnClickListener(new OnClickListener() {
            @Override
            /**
             * The onClick function inside confirmGroup.setOnClickListener determines what happens after the Confirm button on the
             * Create Group Layout is clicked on. Specifically, the function adds each of the users inside the generated TextViews by
             * OnClick in addMember.setOnClickListener into a new TripGroup, and initializes the TripGroup to have the name and currency
             * as specified by the user.
             *
             * The function checks that groups only containing the creator cannot be created, and ensures that the group name is between 2
             * to 20 characters long.
             *
             * Upon successful creation of the group, the function initiates the AllGroupList activity.
             *
             * @param v
             * @see addMember.setOnClickListener
             */
            public void onClick(View v) {
